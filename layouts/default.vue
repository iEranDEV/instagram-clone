<template>
	<div class="min-h-screen flex flex-col justify-between md:justify-start md:flex-row">

		<!-- Navbar -->
		<nav class="bg-white w-full md:h-screen md:w-52 flex justify-center md:justify-around md:items-center md:flex-col fixed bottom-0 md:static">
			<!-- Logo -->
			...
			<div class="w-full md:w-52 flex justify-around md:justify-center md:flex-col">
				...
				<!-- Dicover link -->
				<NavButton route="/accounts/login">
					<template #icon>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
